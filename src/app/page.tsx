...
import { IconDatabase, IconDeviceDesktop, IconDeviceMobile, IconId, IconServer, IconTool } from '@tabler/icons-react'

const createLevelStars = (num: number): string => {
  var stars = '☆☆☆☆☆'
  const _ = [...Array(num)].forEach(()=>(
    stars = stars.replace('☆', '★')
  ))
  return stars
}
...
export default function Home() {
  return (
    <main className='min-h-screen bg-gray-50 flex flex-col items-center'>
      ...
      {/* スキルセットセクション */}
      <section className='w-4/5 m-5'>
        <div className='text-3xl font-bold drop-shadow-md'>スキルセット SKILL</div>
        ...
        <div className='grid grid-rows-2 grid-cols-3 gap-5 m-3'>
          ...
          <div className='bg-primary rounded-3xl text-center text-secondary p-3'>
            ...
            <div className='text-white my-4'>直近ではNext.JSを用いた開発を行っていました</div>
            <table className='w-full my-4'>
              <thead>
                <tr><th>技術</th><th>経験年数</th><th>レベル</th></tr>
              </thead>
              <tbody className='text-white'>
                <tr><td>HTML</td><td>2年</td><td>★★★☆☆</td></tr>
                <tr><td>Tailwind</td><td>1年</td><td>★★★☆☆</td></tr>
                <tr><td>JavaScript</td><td>2年</td><td>★★★★☆</td></tr>
                <tr><td>JavaScript</td><td>2年</td><td>★★★★☆</td></tr>
                <tr><td>TypeScript</td><td>半年</td><td>★★★☆☆</td></tr>
                <tr><td>jQuery</td><td>半年</td><td>★★☆☆☆</td></tr>
                <tr><td>React</td><td>半年</td><td>★★★☆☆</td></tr>
                <tr><td>Next.JS</td><td>半年</td><td>★☆☆☆☆</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className='bg-primary rounded-3xl text-center text-secondary p-3'>
            ...
            <div className='text-white my-4'>アルバイトではLaravelアプリ開発を教えています</div>
            <table className='w-full my-4'>
              <thead>
                <tr><th>技術</th><th>経験年数</th><th>レベル</th></tr>
              </thead>
              <tbody className='text-white'>
                <tr><td>Laravel</td><td>1年</td><td>★★★★☆</td></tr>
                <tr><td>Flask</td><td>半年</td><td>★★☆☆☆</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className='bg-primary rounded-3xl text-center text-secondary p-3'>
            ...
            <div className='text-white my-4'>直近ではSwift UIを用いた開発を行っていました</div>
            <table className='w-full my-4'>
              <thead>
                <tr><th>技術</th><th>経験年数</th><th>レベル</th></tr>
              </thead>
              <tbody className='text-white'>
                <tr><td>Swift(UIKit)</td><td>1年</td><td>{createLevelStars(3)}</td></tr>
                <tr><td>Swift(Swift UI)</td><td>1年</td><td>{createLevelStars(4)}</td></tr>
                <tr><td>KMP</td><td>1ヶ月</td><td>{createLevelStars(1)}</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className='bg-primary rounded-3xl text-center text-secondary p-3'>
            ...
            <div className='text-white my-4'>直近ではmysqlを用いた開発を行っていました</div>
            <table className='w-full my-4'>
              <thead>
                <tr><th>技術</th><th>経験年数</th><th>レベル</th></tr>
              </thead>
              <tbody className='text-white'>
                <tr><td>MySQL(mariadb)</td><td>1年</td><td>{createLevelStars(3)}</td></tr>
                <tr><td>MongoDB</td><td>半年</td><td>{createLevelStars(2)}</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className='bg-primary rounded-3xl text-center text-secondary p-3'>
            ...
            <table className='w-full my-4'>
              ...
              <tbody className='text-white'>
                <tr><td>git</td><td>2年</td><td>{createLevelStars(4)}</td></tr>
                <tr><td>slack</td><td>2年</td><td>{createLevelStars(4)}</td></tr>
                <tr><td>python</td><td>2年</td><td>{createLevelStars(3)}</td></tr>
              </tbody>
            </table>
          </div>
        ...
        <div className='grid grid-rows-2 grid-cols-2 gap-5 my-3'>
          ...
          <div className="bg-primary rounded-3xl p-4">
            ...
            <div className="flex justify-around m-2">
              <div className='flex flex-wrap items-start'>
                <Image src='/icons8-php-96.png' width={50} height={50} alt='php' />
                <Image src='/icons8-ララヴェル-96.png' width={50} height={50} alt='laravel' />
                <Image src='/icons8-react-native-96.png' width={50} height={50} alt='react' />
                <Image src='/icons8-typescript-96.png' width={50} height={50} alt='typescript' />
                <Image src='/icons8-heroku-96.png' width={50} height={50} alt='heroku' />
                <Image src='/icons8-mysql-ロゴ-96.png' width={50} height={50} alt='mysql' />
              </div>
              <Image src={jisui6Image} alt='Jisui6' width={400} height={280} className='rounded-md'/>
            </div>
            ...
            <div className="my-2 text-right text-orange-400 text-sm underline hover:text-orange-300">
              <a href='https://jisui6-700305e97f73.herokuapp.com/'>{'>>'}リンクはこちら</a>
            </div>
            <div className="my-2 text-right text-orange-400 text-sm underline hover:text-orange-300">
              <a href='https://github.com/keigo-u/jisuiroku'>{'>>'}GitHubリポジトリはこちら</a>
            </div>
          </div>
          ...
          <div className="bg-primary rounded-3xl p-4">
            ...
            <div className="flex justify-around m-2">
              <div className='flex flex-wrap items-start'>
                <Image src='/icons8-typescript-96.png' width={50} height={50} alt='typescript' />
                <Image src='/icons8-ejs-96.png' width={50} height={50} alt='ejs' />
                <Image src='/icons8-tensorflow-96.png' width={50} height={50} alt='tensorflow' />
                <Image src='/icons8-アマゾンウェブサービス-96.png' width={50} height={50} alt='aws' />
              </div>
              <Image src={soramojiImage} alt='Soramoji' width={400} height={280} className='rounded-md'/>
            </div>
            <div className='text-white mx-8 my-2 font-semibold'>
            ...
            <div className="my-2 text-right text-orange-400 text-sm underline hover:text-orange-300">
              <a href='https://main.d3ur3rakiel3gv.amplifyapp.com/'>{'>>'}リンクはこちら</a>
            </div>
            <div className="my-2 text-right text-orange-400 text-sm underline hover:text-orange-300">
              <a href='https://github.com/keigo-u/Soramoji'>{'>>'}GitHubリポジトリはこちら</a>
            </div>
          </div>

          {/* ReportManager */}
          <div className="bg-primary rounded-3xl p-4">
            <div className='text-3xl text-secondary font-bold'>ReportManager</div>
            <div className="flex justify-around m-2">
              <div className='flex flex-wrap items-start'>
                <Image src='/icons8-swiftui-96.png' width={50} height={50} alt='swiftui' />
                <Image src='/icons8-mongodb-96.png' width={50} height={50} alt='mongodb' />
              </div>
              <Image src={rmImage} alt='ReportManager' width={400} height={280} className='rounded-md'/>
            </div>
            <div className='text-white mx-8 my-2 font-semibold'>
            ...
            <div className="my-2 text-right text-orange-400 text-sm underline hover:text-orange-300">
              <a href='https://github.com/keigo-u/ReportManager'>{'>>'}GitHubリポジトリはこちら</a>
            </div>
          </div>

          {/* VirtualFitting */}
          <div className="bg-primary rounded-3xl p-4">
            <div className='text-3xl text-secondary font-bold'>VirtualFitting</div>
            <div className="flex justify-around m-2">
              <div className='flex flex-wrap items-start'>
                <Image src='/icons8-swift-96.png' width={50} height={50} alt='swiftui' />
              </div>
              <Image src={vfImage} alt='VirtualFitting' width={200} height={200} className='rounded-md'/>
            </div>
            ...
            <div className="my-2 text-right text-orange-400 text-sm underline hover:text-orange-300">
              <a href='https://github.com/keigo-u/VirtualFitting'>{'>>'}GitHubリポジトリはこちら</a>
            </div>
          </div>
        </div>
      </section>
